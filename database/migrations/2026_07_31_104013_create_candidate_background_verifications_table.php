...
return new class extends Migration
{
    ...
    {
        Schema::create('candidate_background_verifications', function (Blueprint $table) {
            $table->id();
            $table->foreignId('candidate_id')->constrained('candidates')->cascadeOnDelete();
            $table->foreignId('candidate_verification_item_id')->constrained('candidate_verification_items')->cascadeOnDelete();
            $table->unique('candidate_verification_item_id', 'cbv_item_unique');
    ...
    {
        Schema::dropIfExists('candidate_background_verifications');
    }
};
